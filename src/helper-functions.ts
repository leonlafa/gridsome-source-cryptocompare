import { IDisplayData, ICryptoCompareCoinInfo, ICryptoCompareDisplay, IOptions } from "./types"
...
export const mapDisplayData = (display: any, tsym: string): IDisplayData => {
    ...
    try {
        const { FROMSYMBOL, TOSYMBOL, PRICE, LOWDAY, HIGHDAY, OPENDAY, MKTCAP, SUPPLY } = _display;
